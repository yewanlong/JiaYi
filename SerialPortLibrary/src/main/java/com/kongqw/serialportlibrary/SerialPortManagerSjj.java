...
public class SerialPortManagerSjj extends SerialPort {
     ...
     */
    public SerialPortManagerSjj setOnOpenSerialPortListener(OnOpenSerialPortListener listener) {
     ...
     * @return SerialPortManager
     */
    public SerialPortManagerSjj setOnSerialPortDataListener(OnSerialPortDataListener listener) {
    ...
    //第一层
    public byte[] select() {
        byte[] bytes = new byte[]{(byte) 0x01, (byte) 0x05, (byte) 0x00, (byte) 0x01, (byte) 0x07, (byte) 0x0D, (byte) 0x0A};
        return bytes;
    }

    //第二层
    public byte[] select1() {
        byte[] bytes = new byte[]{(byte) 0x01, (byte) 0x05, (byte) 0x00, (byte) 0x02, (byte) 0x08, (byte) 0x0d, (byte) 0x0a};
        return bytes;
    }

    //第三层
    public byte[] select2() {
        byte[] bytes = new byte[]{(byte) 0x01, (byte) 0x05, (byte) 0x00, (byte) 0x03, (byte) 0x09, (byte) 0x0d, (byte) 0x0a};
        return bytes;
    }

    //第四层
    public byte[] select3() {
        byte[] bytes = new byte[]{(byte) 0x01, (byte) 0x05, (byte) 0x00, (byte) 0x04, (byte) 0x0A, (byte) 0x0d, (byte) 0x0a};
        return bytes;
    }

    //第五层
    public byte[] select4() {
        byte[] bytes = new byte[]{(byte) 0x01, (byte) 0x05, (byte) 0x00, (byte) 0x05, (byte) 0x0B, (byte) 0x0d, (byte) 0x0a};
        return bytes;
    }

    //第六层
    public byte[] select5() {
        byte[] bytes = new byte[]{(byte) 0x01, (byte) 0x05, (byte) 0x00, (byte) 0x06, (byte) 0x0C, (byte) 0x0d, (byte) 0x0a};
        return bytes;
    }

    //下降
    public byte[] select6() {
        byte[] bytes = new byte[]{(byte) 0x01, (byte) 0x05, (byte) 0x00, (byte) 0x00, (byte) 0x06, (byte) 0x0d, (byte) 0x0a};
        return bytes;
    }

    //出货
    public byte[] select7() {
        byte[] bytes = new byte[]{(byte) 0x01, (byte) 0x01, (byte) 0x01, (byte) 0x00, (byte) 0x03, (byte) 0x0d, (byte) 0x0a};
        return bytes;
    }

    //开门
    public byte[] select8() {
        byte[] bytes = new byte[]{(byte) 0x01, (byte) 0x01, (byte) 0x00, (byte) 0x00, (byte) 0x02, (byte) 0x0d, (byte) 0x0a};
        return bytes;
    }

    //关门
    public byte[] select9() {
        byte[] bytes = new byte[]{(byte) 0x01, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x02, (byte) 0x0d, (byte) 0x0a};
        return bytes;
    }
